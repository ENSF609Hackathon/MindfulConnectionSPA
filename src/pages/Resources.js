                                        ...
                                        <div className="col-lg-12">
                                            ...
                                            <ul className="list-inline mb-4">
                                                ...
                                                <li className="list-inline-item d-block border-bottom me-0"><Link
                                                    ...
                                                    className="btn-round-md bg-gold-gradiant text-white feather-heart font-md me-3"></i>
                                                ...
                                                <li className="list-inline-item d-block border-bottom me-0"><Link
                                                    ...
                                                    className="btn-round-md bg-gold-gradiant text-white feather-info font-md me-3"></i>
