    ...
    render() {
        return (
            <Fragment> 
                ...
                <div className="main-content bg-lightblue3 theme-dark-bg right-chat-active">
            
                    <div className="middle-sidebar-bottom">
                        <div className="middle-sidebar-left">
                            <div className="middle-wrap">
                                <div className="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                                    <div className="card-body p-4 w-100 bg-current d-flex rounded-3">
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-lg-4 text-center">
                                            ...
                                            <h2 className="fw-700 font-sm text-grey-900 mt-3">Eric Lee</h2>
                                            <h4 className="text-grey-500 fw-500 mb-3 font-xsss mb-4">Calgary</h4>    
                                    ...
                                    <form action="#">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-6 mb-3">
                                                <div className="form-group">
                                                    <label className="mont-font fw-600 font-xsss mb-2">Postal Code</label>
                                                    <input type="text" className="form-control" />
                                                </div>        
                                            </div>
