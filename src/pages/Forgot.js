                            ...
                            <div className="card shadow-none border-0 ms-auto me-auto login-card">
                                <div className="card-body rounded-0 text-left">
                                    ...
                                    <div className="col-sm-12 p-0 text-left">
                                        <div className="form-group mb-1"><a href="/src/pages/Splash" className="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0 ">Change Password</a></div>
