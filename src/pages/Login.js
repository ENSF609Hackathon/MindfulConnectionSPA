                ...
                <div className="main-wrap">
                    <div className="nav-header bg-transparent shadow-none border-0">
                        ...
                        <button className="nav-menu me-0 ms-auto"></button>
                            <a href="/login" className="header-btn d-none d-lg-block bg-blue fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 rounded-xl">Login</a>
                            ...
                            <div className="col-xl-7 vh-100 align-items-center d-flex bg-white rounded-3 overflow-hidden">
                                <div className="card shadow-none border-0 ms-auto me-auto login-card">
                                    <div className="card-body rounded-0 text-left">
                                        <h2 className="fw-700 display1-size display2-md-size mb-3">Caring <br />starts here!</h2>
                                        <form>
                                            ...
                                            <div className="form-check text-left mb-3">
                                                ...
                                                <label className="form-check-label font-xsss text-grey-500" style={{ marginTop: '5px' }}>
                                                    Remember me
                                                </label>
