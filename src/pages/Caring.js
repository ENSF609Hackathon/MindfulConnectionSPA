                                            ...
                                            <div className="col-lg-12">
                                                ...
                                                {showGeneral && (
                                                    <ul className="list-inline mb-4">
                                                        <li className="list-inline-item d-flex align-items-center border-bottom me-0">
                                                            <Link to="/replace" className="pt-2 pb-2 d-flex align-items-center position-relative">
                                                                ...
                                                                <h4 className="fw-600 font-xss mb-0 mt-0" style={{ marginLeft: '20px' }}>James Doe</h4>
                                                        ...
                                                        <li className="list-inline-item d-flex align-items-center border-bottom me-0 position-relative">
                                                            <Link to="/replace2" className="pt-2 pb-2 d-flex align-items-center position-relative">
                                                                <div className="position-relative">
                                                                ...
                                                                <h4 className="fw-600 font-xss mb-0 mt-0" style={{ marginLeft: '20px' }}>Jane Doe</h4>
                                                                <i className="ti-angle-right font-xsss text-grey-500" style={{ marginLeft: '20px' }}></i>
                                                            </Link>
                                                        </li>
                                                ...
                                                {showOther && (
                                                    <ul className="list-inline">
                                                        <li className="list-inline-item d-flex align-items-center border-bottom me-0 position-relative">
                                                            <Link to="/replace3" className="pt-2 pb-2 d-flex align-items-center position-relative">
                                                                <div className="position-relative">
                                                                    <img src="assets/images/man2.png" alt="man" style={{ width: '60px', height: '60px', borderRadius: '50%', marginLeft: '50px' }} />
                                                                    <span className="badge bg-danger position-absolute top-0 end-0">1</span>
                                                                </div>
                                                                <h4 className="fw-600 font-xss mb-0 mt-0" style={{ marginLeft: '20px' }}>Jacob Doe</h4>
                                                                <i className="ti-angle-right font-xsss text-grey-500" style={{ marginLeft: '20px' }}></i>
                                                            </Link>
                                                        </li>
                                                        {/* Add more list items as needed */}
