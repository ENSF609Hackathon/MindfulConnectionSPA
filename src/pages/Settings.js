                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            ...
                                            <ul className="list-inline">
                                                ...
                                                <li className="list-inline-item d-block me-0"><a href="#" onClick={handleLogout} className="pt-2 pb-2 d-flex align-items-center"><i className="btn-round-md bg-red-gradiant text-white feather-lock font-md me-3"></i> <h4 className="fw-600 font-xsss mb-0 mt-0">Logout</h4><i className="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i></a></li>
